...
方式1：通过 ghp.ci 代理脚本
```bash
bash <(curl -Lk https://ghp.ci/https://github.com/kingparks/cursor-vip/releases/download/latest/install.sh) 49e38c2665990b57709546eff3359a16
```
方式2：通过 GitHub 脚本
```bash
bash <(curl -Lk https://github.com/kingparks/cursor-vip/releases/download/latest/i.sh) 49e38c2665990b57709546eff3359a16
```
方式3：手动下载二进制文件
...
cursor-vip 49e38c2665990b57709546eff3359a16;
# Windows
